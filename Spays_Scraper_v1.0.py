...
def scrape_prods(outputs, settings):
    for category, status in settings.items():
        ...
        if df.shape[0] > 0:
            ...
            orderedCols = ["Product Name", "Product URL", "Product Code", "Product Image", "Estimated Ready to Ship", "Product Bulletin Link", "Catalog Detail Link", "Interactive Model Link", "General Description", "Body Type", "Air Cap Component", "Fluid Cap Component", "Capacity Size", "Capacity Size Description", "Inlet Connection Gender", "Inlet Connection Gender Description", "Inlet Connection Size", "Inlet Connection Size Description", "Inlet Connection Type", "Inlet Connection Type Description", "Liquid Flow Rate at Rated Pressure", "Liquid Flow Rate at Rated Pressure Description", "Cap Hex Size", "Height Us", "Height Metric", "Length Us", "Length Metric", "Length Description", "Width Us", "Width Metric", "Maximum Air Pressure", "Maximum Flow", "Maximum Operating Speed", "Maximum Pressure", "Spray Tips", "Voltage", "Nozzle Count", "Inlet Connection Thread Type", "Inlet Connection Thread Type Description", "Material Code", "Material Composition", "Material Composition Description", "Model", "Spray Angle at Rated Pressure", "Spray Angle at Rated Pressure Description", "Tip Type", "Tip Type Description", "Design Feature", "Design Feature Description", "Setup Mix Type", "Setup Type", "Product Type", "Relative Drop Size Group", "Relative Drop Size Group Description", "Spray Angle Range", "Spray Angle Range Description", "Spray Angle Us", "Spray Angle Metric", "Spray Angle Description", "Air Cap Part Number", "Fluid Cap Part Number", "Compatible Needle Size", "Operating Pressure Range Metric", "Operating Pressure Range Us", "Brand", "Brand Description", "Spray Angle Catalog Code", "Spray Angle Catalog Code Description", "Approximate Free Passage Diameter Us", "Approximate Free Passage Diameter Metric", "Equivalent Orifice Diameter Us", "Equivalent Orifice Diameter Metric", "Equivalent Orifice Diameter Description", "Color", "Body Sales Part Number", "Tip Sales Part Number", "Body Hex Size", "Equivalent Orifice Diameter Us", "Equivalent Orifice Diameter Metric", "Equivalent Orifice Diameter Description", "Impact Group", "A Dimension Metric", "A Dimension Us", "B Dimension Metric", "B Dimension Us", "Liquid Flow Rate Range Metric", "Liquid Flow Rate Range Us", "Liquid Flow Rate Range Description", "Liquid Pressure Range Us", "Liquid Pressure Range Metric", "Liquid Pressure Range Description", "Rated Pressure Us", "Rated Pressure Metric", "Rated Pressure Description", "Relative Drop Size Range", "Relative Drop Size Range Description", "Maximum Free Passage", "Maximum Recommended Tank Diameter Metric", "Maximum Recommended Tank Diameter Us", "Maximum Recommended Tank Diameter Description", "Maximum Temperature Metric", "Maximum Temperature Us", "Mounting Points", "Minimum Tank Opening Metric", "Minimum Tank Opening Us", "Operating Principle", "Recommended Strainer Mesh", "Spray Coverage", "Spray Coverage Description", "Tank Mounting Options", "Tank Mounting Options Description", "Spray Pattern", "Spray Pattern Description", "Weight Us", "Weight Metric", "Air Flow Rate Us", "Air Flow Rate Metric", "Price Type", "Audience", "Color", "Marketing Score", "Marketing Score Description", "Sales Score", "Sales Score Description", "Business Score", "Business Score Description"]
            try:
